...
public class dateandtime {
   ...
   static  void f1()
    ...
    public static void main(String[]args){
        ...
        int asd = s.nextInt();
        LocalDateTime pd =dt.plusHours(asd);
        LocalDateTime md =dt.minusHours(asd);
        System.out.println("Current Date : "+ dt.format(fdt));
       ...
       System.out.println("Enter the number of Month to Add and subtract");
        int asm = s.nextInt();
        LocalDateTime pm =dt.plusHours(asm);
        LocalDateTime mm =dt.minusHours(asm);
        System.out.println("Current Date : "+ dt.format(fdt));
        System.out.println("After Adding "+ asm + " Month:"+ pm.format(fdt));
        System.out.println("After Subtracting "+ asm + " Month:"+ mm.format(fdt));
        ...
        System.out.println("Current Date : "+ dt.format(fdt));
        System.out.println("After Subtracting "+ sy + " year : "+ my.format(fdt));

    //6.Convert current date in to Unix time format
    Date ux=new Date();
    Long p= ux.getTime()/1000;
    System.out.println(" Unix time format "+ p);
